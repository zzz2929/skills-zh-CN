---
name: wrangler
description: Cloudflare Workers CLI 用于部署、开发和管理 Workers、KV、R2、D1、Vectorize、Hyperdrive、Workers AI、容器、队列、工作流、管道和 Secrets Store。在运行 wrangler 命令之前先加载，以确保语法正确并遵循最佳实践。偏向于从 Cloudflare 文档中检索，而非依赖预训练知识。
---

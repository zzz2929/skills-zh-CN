---
name: cloudflare
description: 全面的Cloudflare平台技能，涵盖Workers、Pages、存储（KV、D1、R2）、人工智能（Workers AI、Vectorize、Agents SDK）、功能标志（Flagship）、网络（Tunnel、Spectrum）、安全（WAF、DDoS）以及基础设施即代码（Terraform、Pulumi）。可用于任何Cloudflare开发任务。偏向于从Cloudflare文档中检索，而非预训练知识。
references:
  - workers
  - pages
  - d1

---
name: ui-ux-pro-max
description: “用于网络和移动设备的UI/UX设计智能。可搜索的本地数据库，包含84种风格、192种调色板、74种字体配对、192种产品类型、98种用户体验指南、104个图标条目、16个GSAP运动预设和22个堆栈中的25种图表类型（React、Next.js、Vue、Nuxt、Svelte、Astro、SwiftUI、React Native、Flutter、Tailwind、shadcn/UI、Jetpack Compose、Angular、Laravel、JavaFX、WPF、WinUI、Avalonia、Uno Platform、UWP、Three.js和HTML/CSS）。在设计、构建或查看UI时使用：页面、组件、配色方案、排版、布局、可访问性、动画或数据可视化。”
---
